...
- [第1章：AI 编码 Agent 的完整技术栈](./part1/ch01.md)
- [第2章：工具系统 — 40+ 个工具作为模型的双手](./part1/ch02.md)
- [第3章：Agent Loop — 从用户输入到模型响应的完整生命周期](./part1/ch03.md)
- [第4章：工具执行编排 — 权限、并发、流式与中断](./part1/ch04.md)
- [第4b章：计划模式 — 从"先做后看"到"先看后做"](./part1/ch04b.md)

---

# 第二篇：提示工程 — 系统提示词作为控制面

- [第5章：系统提示词架构](./part2/ch05.md)
- [第6章：通过提示词引导行为](./part2/ch06.md)
- [第6b章：API 通信层 — 重试、流式与降级工程](./part2/ch06b.md)
- [第7章：模型特定调优与 A/B 测试](./part2/ch07.md)
- [第8章：工具提示词作为微型驾驭器](./part2/ch08.md)

---

# 第三篇：上下文管理 — 200K Token 竞技场

- [第9章：自动压缩 — 上下文何时以及如何被压缩](./part3/ch09.md)
- [第10章：压缩后的文件状态保留](./part3/ch10.md)
- [第11章：微压缩 — 精准上下文修剪](./part3/ch11.md)
- [第12章：Token 预算策略](./part3/ch12.md)

---

# 第四篇：提示词缓存 — 隐藏的成本优化器

- [第13章：缓存架构与断点设计](./part4/ch13.md)
- [第14章：缓存中断检测系统](./part4/ch14.md)
- [第15章：缓存优化模式](./part4/ch15.md)
