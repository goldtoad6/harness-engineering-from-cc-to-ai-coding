...
- [Chapter 1: The Full Tech Stack of an AI Coding Agent](./part1/ch01.md)
...
- [Chapter 5: System Prompt Architecture](./part2/ch05.md)
- [Chapter 6: Steering Behavior Through Prompts](./part2/ch06.md)
- [Chapter 6b: API Communication Layer — Retry, Streaming, and Degradation Engineering](./part2/ch06b.md)
- [Chapter 7: Model-Specific Tuning and A/B Testing](./part2/ch07.md)
- [Chapter 8: Tool Prompts as Micro-Harnesses](./part2/ch08.md)

---

# Part III: Context Management — The 200K Token Arena

- [Chapter 9: Automatic Compaction — When and How Context Gets Compressed](./part3/ch09.md)
- [Chapter 10: File State Preservation After Compaction](./part3/ch10.md)
- [Chapter 11: Micro-Compaction — Precise Context Pruning](./part3/ch11.md)
- [Chapter 12: Token Budgeting Strategies](./part3/ch12.md)

---

# Part IV: Prompt Caching — The Hidden Cost Optimizer

- [Chapter 13: Cache Architecture and Breakpoint Design](./part4/ch13.md)
- [Chapter 14: Cache Break Detection System](./part4/ch14.md)
- [Chapter 15: Cache Optimization Patterns](./part4/ch15.md)
...
- [Chapter 20: Agent Spawning and Orchestration](./part6/ch20.md)
- [Chapter 20b: Teams and Multi-Process Collaboration](./part6/ch20b.md)
- [Chapter 20c: Ultraplan — Remote Multi-Agent Planning](./part6/ch20c.md)
...
- [Chapter 22b: Plugin System — From Packaging to Marketplace Extension Engineering](./part6/ch22b.md)
...
- [Chapter 29: Observability Engineering — From logEvent to Production-Grade Telemetry](./part7/ch29.md)
- [Chapter 30: Build Your Own AI Agent — From Claude Code Patterns to Practice](./part7/ch30.md)

---

# Appendix

- [Appendix A: Key File Index](./appendix/a-file-index.md)
- [Appendix B: Environment Variable Reference](./appendix/b-env-vars.md)
